...
public class LemonTreeGrower extends AbstractTreeGrower {
    ...
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull RandomSource randomSource, boolean beehive) {
        return beehive ? ResourceKey.create(Registries.CONFIGURED_FEATURE, modPrefix("trees/lemon_bees_005")) : ResourceKey.create(Registries.CONFIGURED_FEATURE, modPrefix("trees/lemon"));
    }
}

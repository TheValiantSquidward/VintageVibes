...
public class LimeTreeGrower extends AbstractTreeGrower {
    ...
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull RandomSource randomSource, boolean beehive) {
        return beehive ? ResourceKey.create(Registries.CONFIGURED_FEATURE, modPrefix("trees/lime_bees_005")) : ResourceKey.create(Registries.CONFIGURED_FEATURE, modPrefix("trees/lime"));
    }
}

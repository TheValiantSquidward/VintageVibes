...
public class OrangeTreeGrower extends AbstractTreeGrower {
    ...
    protected ResourceKey<ConfiguredFeature<?, ?>> getConfiguredFeature(@NotNull RandomSource randomSource, boolean beehive) {
        return beehive ? ResourceKey.create(Registries.CONFIGURED_FEATURE, modPrefix("trees/orange_bees_005")) : ResourceKey.create(Registries.CONFIGURED_FEATURE, modPrefix("trees/orange"));
    }
}

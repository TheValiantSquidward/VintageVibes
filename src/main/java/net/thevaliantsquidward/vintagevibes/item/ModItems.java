...
public class ModItems {
    ...
    public static final RegistryObject<Item> VIBE = ITEMS.register("vibe",
            () -> new RecordItem(6, ModSounds.VIBE, new Item.Properties().stacksTo(1).rarity(Rarity.RARE), 1360));

...
public class VVBlockProperties {
    ...
    public static final BlockBehaviour.Properties SKULL = BlockBehaviour.Properties.of().strength(1.0F).pushReaction(PushReaction.DESTROY).mapColor(MapColor.STONE);

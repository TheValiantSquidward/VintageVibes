...
public class VVItems {
    ...
    //trinkets
    public static final RegistryObject<Item> AMBERIZED_CRITTER = registerItem("amberized_critter", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> ANCIENT_FIGURINE = registerItem("ancient_figurine", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> ANTIQUE_KEY = registerItem("antique_key", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> BEJEWELED_BROOCH = registerItem("bejeweled_brooch", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> BLOSSOM_NECKLACE = registerItem("blossom_necklace", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> CHIPPED_RING = registerItem("chipped_ring", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> CITRINE_DIAMOND = registerItem("citrine_diamond", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> COPPER_APPLE = registerItem("copper_apple", () -> new TrinketItem(new Item.Properties().rarity(VVItemProperties.TRINKET).food(VVFoodValues.COPPER_APPLE)));
    public static final RegistryObject<Item> CORAL_BEADS = registerItem("coral_beads", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    ...
    public static final RegistryObject<Item> OLD_TOKEN = registerItem("old_token", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> ONYX_FIGURINE = registerItem("onyx_figurine", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    ...
    public static final RegistryObject<Item> SIRENS_PEARL = registerItemNoLang("sirens_pearl", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> SPLIT_MASK = registerItem("split_mask", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> WEATHERED_COIN = registerItem("weathered_coin", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> WHIMSICAL_BUNDLE = registerItem("whimsical_bundle", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> BRITTLE_VASE = registerItem("brittle_vase", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> COMEDY_MASK = registerItem("comedy_mask", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> CREATURE_MASK = registerItem("creature_mask", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> CRYSTALLIZED_SHELL = registerItem("crystallized_shell", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    ...
    public static final RegistryObject<Item> OSSEOUS_PICKAXE = registerItem("osseous_pickaxe", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    public static final RegistryObject<Item> OSSEOUS_SWORD = registerItem("osseous_sword", () -> new TrinketItem(VVItemProperties.TRINKET_PROPERTIES));
    ...
    public static final RegistryObject<Item> ENERGY_SPEAR = registerItem("energy_spear", () -> new EnergySpearItem(VVItemProperties.TRINKET_PROPERTIES));

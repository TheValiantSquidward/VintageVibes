...
public class VVBlockTags {
    ...
    public static final TagKey<Block> FLOWERING_LEAVES = modBlockTag("flowering_leaves");

    public static final TagKey<Block> BEES_POLLINATE = modBlockTag("bees_pollinate");

    ...
    public static final RegistryObject<CreativeModeTab> VINTAGE_VIBES_TAB = CREATIVE_TABS.register("vintage_vibes_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(VVBlocks.PINK_HIBISCUS.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(VVItems.ROUGH_AQUAMARINE.get());
                        pOutput.accept(VVItems.ENSTATITE.get());
                        pOutput.accept(VVItems.ROUGH_ENSTATITE.get());
                        pOutput.accept(VVItems.GARNET.get());
                        pOutput.accept(VVItems.ROUGH_GARNET.get());
                        pOutput.accept(VVItems.JADE.get());
                        pOutput.accept(VVItems.ROUGH_JADE.get());
                        pOutput.accept(VVItems.KUNZITE.get());
                        pOutput.accept(VVItems.ROUGH_KUNZITE.get());
                        pOutput.accept(VVItems.LARIMAR.get());
                        pOutput.accept(VVItems.ROUGH_LARIMAR.get());
                        pOutput.accept(VVItems.MILKY_QUARTZ.get());
                        pOutput.accept(VVItems.ROUGH_MILKY_QUARTZ.get());
                        pOutput.accept(VVItems.MOONSTONE.get());
                        pOutput.accept(VVItems.ROUGH_MOONSTONE.get());
                        pOutput.accept(VVItems.ONYX.get());
                        pOutput.accept(VVItems.ROUGH_ONYX.get());
                        pOutput.accept(VVItems.PERIDOT.get());
                        pOutput.accept(VVItems.ROUGH_PERIDOT.get());
                        pOutput.accept(VVItems.ROSE_QUARTZ.get());
                        pOutput.accept(VVItems.ROUGH_ROSE_QUARTZ.get());
                        pOutput.accept(VVItems.SAPPHIRE.get());
                        pOutput.accept(VVItems.ROUGH_SAPPHIRE.get());
                        pOutput.accept(VVItems.SMOKY_QUARTZ.get());
                        pOutput.accept(VVItems.ROUGH_SMOKY_QUARTZ.get());
                        pOutput.accept(VVItems.TAAFFEITE.get());
                        pOutput.accept(VVItems.ROUGH_TAAFFEITE.get());
                        pOutput.accept(VVItems.TOPAZ.get());
                        pOutput.accept(VVItems.ROUGH_TOPAZ.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_AMBER_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_ENSTATITE_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_GARNET_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_JADE_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_KUNZITE_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_LARIMAR_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_MILKY_QUARTZ_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_MOONSTONE_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_ONYX_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_PERIDOT_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_ROSE_QUARTZ_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_SAPPHIRE_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_SMOKY_QUARTZ_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_TAAFFEITE_BLOCK.get());
                        ...
                        pOutput.accept(VVBlocks.ROUGH_TOPAZ_BLOCK.get());
